...
FileModel = (function(_super) {
  ...
  FileModel.prototype.contextualize = function(opts, next) {
    var changes, escapedRelativePath, filename, meta, name, outDirPath, outPath, relativeBase, relativeDirPath, relativeOutDirPath, relativeOutPath, relativePath, slug, url, _ref2;
    if (opts == null) {
      opts = {};
    }
    _ref2 = this.getActionArgs(opts, next), opts = _ref2.opts, next = _ref2.next;
