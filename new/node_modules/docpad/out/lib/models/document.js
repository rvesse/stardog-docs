  ...
  DocumentModel.prototype.contextualize = function(opts, next) {
    ...
    DocumentModel.__super__.contextualize.call(this, opts, function() {
      return _this.getEve(function(err, eve) {
        var basename, changes, escapedRelativeOutPath, extensions, fullPath, meta, name, outContentType, outExtension, outFilename, outPath, relativeDirPath, relativeOutPath, url;
        if (err) {
          return next(err);
        }
        changes = {};
